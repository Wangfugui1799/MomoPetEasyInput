...
const app=await electron.launch({executablePath:path.resolve('dist/wireless/Momo-darwin-arm64/Momo.app/Contents/MacOS/Momo'),args:[`--user-data-dir=${profile}`],env:{...process.env,MOMO_DESKTOP_PORT:'4788'},timeout:30000});
try{
  ...
  await page.screenshot({path:'docs/momo-wireless-settings.png',fullPage:true});
