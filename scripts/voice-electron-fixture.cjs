...
app.whenReady().then(async()=>{
 ...
 const win=new BrowserWindow({width:1280,height:950,show:true,webPreferences:{contextIsolation:true,nodeIntegration:false,sandbox:true,backgroundThrottling:false}});
