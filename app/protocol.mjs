...
export function parseEvent(line) {
  ...
  if(e.type==='hello' && e.board==='easyinput-v2' && typeof e.firmware==='string') return {type:'hello',firmware:e.firmware.slice(0,32),sound:e.sound===true,mic:e.mic==='pcm16-usb-v1'};
